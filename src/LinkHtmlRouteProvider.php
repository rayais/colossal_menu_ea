...
/**
 * @file
 * Contains \Drupal\colossal_menu\LinkHtmlRouteProvider.
 */
...
/**
 * Provides routes for Link entities.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class LinkHtmlRouteProvider extends AdminHtmlRouteProvider {
  /**
   * {@inheritdoc}
   */
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view link entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      if ($bundle_entity_type_id = $entity_type->getBundleEntityType()) {
        $route
          ->setDefaults([
            '_controller' => 'Drupal\colossal_menu\Controller\LinkAddController::addForm',
            '_title_callback' => 'Drupal\colossal_menu\Controller\LinkAddController::getAddFormTitle',
          ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\colossal_menu\Controller\LinkAddController::add',
          '_title' => "Add {$entity_type->getLabel()}",
        ])
